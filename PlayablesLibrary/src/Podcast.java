...
public class Podcast{
    ...
    public class Episode implements Playable, Cloneable {
         ...
         *
         * @param o
         *            The object to compare an episode to
         * @return    This method returns true if the episode is the same as the obj argument; false otherwise.
         */
        @Override
        public boolean equals(Object o) {
            if (this == o) return true;
        ...
        /**
         * Equal episodes have the same hashcode
         */
        @Override
        public int hashCode() {
